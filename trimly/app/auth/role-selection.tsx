  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        {/* @ts-ignore */}
        <Link href={{ pathname: '/auth/sign-up', params: { role: 'customer' } }} style={styles.customerButton}>
          <ThemedText style={styles.customerButtonText}>Customer</ThemedText>
        </Link>
        
        {/* Vendor Button - Secondary */}
        {/* @ts-ignore */}
        <Link href={{ pathname: '/auth/sign-up', params: { role: 'vendor' } }} style={styles.vendorButton}>
