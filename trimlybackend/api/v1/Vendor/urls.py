...
urlpatterns = [
    ...
    path("vendors/<int:vendor_id>/services/<int:id>/", VendorServicesRetrieveUpdateDeleteAPIView.as_view(), name="vendor_retrieve"),
    path("vendors/<int:id>/gallery",VendorGalleryUploadAPIView.as_view(), name="vendor_portfolio" ),
    path("vendors/<int:vendor_id>/availability/", VendorAvailabilityListCreateAPIView.as_view(), name="vendor_availability"),
    path("vendors/<int:vendor_id>/availability/<int:id>/", VendorAvailabilityRetrieveUpdateDeleteAPIView.as_view(), name="vendor_retrieve_availaibility"),
