...
class IndividualVendorProfile(models.Model):
    ...
    # Financial Infrastructure Payout Anchors (Subaccount removed!)
    ...
    # IndividualVendorProfile model
    flw_recipient_id = models.CharField(max_length=100, null=True, blank=True)
